...
router.post('/usuarios', async (req,res)=>{
    ...
    const comprobacionEmail = await usuarioEsquema.findOne({email: usuario.email});
    const comprobacionNombreusuario = await usuarioEsquema.findOne({nombreusuario: usuario.nombreusuario})
